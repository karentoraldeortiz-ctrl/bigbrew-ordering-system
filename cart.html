    ...
    <div class="cart-container">
      <main>
        <div class="cart-header">
          ...
          <div>
            <img src="assets/pictures/store-pic.jpg" alt="" />
          </div>
        </div>
      ...
      <aside>
        <div class="order-summary-content">
          ...
          <select name="pickup-time" id="pick-up-time" class="summary-input">
          ...
          <div class="subtotal-container">
            <div class="subtotal-row">
              <span id="totalSub">Subtotal</span>
              <span id="subtotal-amount">P 0</span>
            </div>

            <div class="subtotal-row total-bold">
              <span id="totalPrice">Total</span>
              <span id="total-amount">P 0</span>
            </div>
          </div>
