...
<html lang="en">
  <head>
    ...
    <title>BigBrew | Privacy Policy</title>
  ...
  <body>
    ...
    <div class="hero">
      <div class="hero-box">
        <div class="hero-text">
          ...
          <p>
            To ensure accuracy, this Privacy Notice is updated periodically.
            This notice was last updated on April 2026.
          </p>
        </div>
      </div>
    ...
    <section>
      <h3>Last Updated: April 2026</h3>
      <p>
        At BigBrew Maysan, we value your privacy. This document explains what
        information we collect and how we use it for your online pre-orders.
      </p>

      <div class="text-group">
        <h3>1. Information We Collect</h3>
        <p>When you place an order, we collect the following:</p>
        <ul>
          <li>Name: To identify your order at the pick-up point.</li>
          <li>Email: To notify you regarding your order status/</li>
          <li>Order Details: Your chosen drinks and add-ons.</li>
        </ul>
      </div>
      <div class="text-group">
        ...
        <ul>
          <li>Processing your pre-order.</li>
          <li>Communicating with you if an item is out of stock.</li>
          <li>Improving our shop's services.</li>
        </ul>
      </div>
      <div class="text-group">
        ...
        <p>
          ...
          companies. Your data is used exclusively for this transaction.
        </p>
      </div>
    </section>
